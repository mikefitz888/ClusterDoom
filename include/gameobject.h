...
namespace gameobject {
    ...
    */
    ...
    enum OBJECT_TYPE : unsigned int { SPAWN = 0, PROJECTILE_BOMB = 1, PROJECTILE_LASER = 2, PROJECTILE_ELECTRICITY = 3, GAME_STATE_NOTIFIER = 4, RESOURCE_MINE = 5, SPECIAL_TOKEN = 6 };
